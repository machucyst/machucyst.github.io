...
let select = data.games.normal[params.get("selected")]
...
//     images.push(`url(../../../../images/Games/Normal/${select.imageDir}/${img}`)
// })
...
// img.src = `url(../../../../images/Games/Normal/${select.imageDir}/${select.favorite.image}`
